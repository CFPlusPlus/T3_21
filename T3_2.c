...
{
if(gewinnpruefer(11) == 1){printf("Spieler 1 hat Gewonnen!");}    
if(gewinnpruefer(11) == 3){printf("Unentschieden!");} 
printf("\nNoch mal? (Y/N)\n");
fflush(stdin);
scanf("%c", &neueRunde);
...
{
if(auswahl == 2){
    if(gewinnpruefer(22) == 1){printf("Der Computer hat Gewonnen!");}    
}
else{
    if(gewinnpruefer(22) == 1){printf("Spieler 2 hat Gewonnen!");} 
}

if(gewinnpruefer(22) == 3){printf("Unentschieden!");} 
printf("\nNoch mal? (Y/N)\n");
fflush(stdin);
scanf("%c", &neueRunde);
...
for(i=0; i<=2;i++){
    if(spielfeld[i] == 11){
        //X wird nun in blau dargestellt 
